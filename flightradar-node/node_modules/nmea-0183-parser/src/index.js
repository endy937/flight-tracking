...
class Parser {
    constructor(opts = {
        ...
        onPropertyValues: (a, b) => undefined,
    }) {
        ...
        console.log(hooks_1.default);
        this.hooks = Object.assign({}, hooks_1.default);
    ...
    parse(sentence) {
        ...
        let valid = utils_1.default.valid(sentence, this.options.validateChecksum);
        if (valid === false) {
